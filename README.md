...
Сервис также взаимодействует со всеми основными репозиториями, так как необходимо производить операции загрузки
...
- перечисление StaticMenuItem - для объявления названия элемента меню и представления идентификатора, посредством
  которого происходит связь элемента меню и меню
- классы меню, расположенные в пакете menu.main, которые производят наполнение элементов меню и реализуют, при
